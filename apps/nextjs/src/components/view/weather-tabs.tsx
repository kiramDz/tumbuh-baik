...
const YearlyCalender = dynamic(
  () =>
    import("./calender/planting-calender-2").then((mod) => ({
      default: mod.YearlyCalender,
    })),
  {
    loading: () => (
...
const ChartPetani = dynamic(
  () =>
    import("../kuesioner-chart/chartpetani").then((mod) => ({
      default: mod.ChartPetani,
    })),
  {
    loading: () => (
      <div className="h-64 bg-gray-200 dark:bg-gray-800 rounded-lg" />
...
const AboutContent = dynamic(
  () =>
    import("./about/about-main").then((mod) => ({ default: mod.AboutContent })),
  {
    loading: () => (
      <div className="h-64 bg-gray-200 dark:bg-gray-800 rounded-lg" />
    ),
...
export const WeatherTabs = React.memo<ProjectTabsProps>(
  ({ defaultTab = "activity", children }) => {

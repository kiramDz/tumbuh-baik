  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="pb-0">
        ...
        <CardDescription>Air Quality Index (AQI): {getAQIDescription(latestData.main.aqi)}</CardDescription>
      </CardHeader>
                  ...
                  return (
                    <div className="rounded-lg border bg-background p-2 shadow-sm">
                      <div className="flex flex-col gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">{data.value.toFixed(2)} μg/m³</span>
                      </div>
                    </div>
                  );
                }}
              />
              <Pie data={chartData} dataKey="value" nameKey="name" innerRadius="50%" outerRadius="80%" strokeWidth={6}>
                <Label
                  content={({ viewBox }) => {

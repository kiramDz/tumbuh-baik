...
export default function MapSection() {
  ...
  return (
    <Card className="relative overflow-hidden overscroll-contain p-0 md:p-0">
      ...
      >
        <Source key={MapCode} id="weatherSource" type="raster" tiles={[`https://maps.openweathermap.org/maps/2.0/weather/${MapCode}/{z}/{x}/{y}?appid=${OPENWEATHERMAP_TOKEN}`]} tileSize={256}>
          <Layer {...weatherLayer} />
        </Source>
      </ReactMapGL>
    </Card>

                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      {mounted && (
                        <Badge
                          variant="secondary"
                          className="mt-2 text-sm font-mono bg-black/30 text-white border-white/20 backdrop-blur-sm hover:bg-black/40"
                        >
                        ...
                        >
                          <CardContent className="p-3">
                            <div className="flex items-center gap-2.5">
                              <div
                                className={`p-2 rounded-md ${stat.bg} border ${stat.border}`}
                              >

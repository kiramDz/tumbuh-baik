      ...
      <PageContainer>
        <div className="flex flex-1 flex-col gap-4 space-y-2">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Link href="/dashboard/bmkg-station">
              <Card className="w-full relative overflow-hidden  flex flex-col h-48 rounded-xl ">
                <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-6 pb-8  ring-gray-900/5 transition-all duration-300   sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                  ...
                  <div className="relative z-10 mx-auto max-w-md">
                    ...
                    <div className="text-muted-foreground text-base">Data cuaca dari stasiun BMKG Aceh Besar</div>
                  </div>
                </div>
              </Card>
            </Link>
            ...
            <Card className="w-full relative overflow-hidden  flex flex-col h-48 rounded-xl ">
              <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-6 pb-8  ring-gray-900/5 transition-all duration-300   sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                ...
                <div className="relative z-10 mx-auto max-w-md">
                  ...
                  <div className="line-clamp-1 md:mt-6 flex gap-2 font-medium">DAILY WEATHER</div>
                  <div className="text-muted-foreground text-base">Perkiraan cuaca harian dari openweather</div>
                </div>
              </div>
            </Card>
            <Card className="w-full relative overflow-hidden  flex flex-col h-48 rounded-xl ">
              <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-6 pb-8  ring-gray-900/5 transition-all duration-300   sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                ...
                <div className="relative z-10 mx-auto max-w-md">
                  ...
                  <div className="text-muted-foreground text-base">Gambaran kondisi lahan dan vegetasi berbasis citra satelit </div>
                </div>
              </div>
            </Card>
            <Card className="w-full relative overflow-hidden  flex flex-col h-48 rounded-xl ">
              <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-6 pb-8  ring-gray-900/5 transition-all duration-300   sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                ...
                <div className="relative z-10 mx-auto max-w-md">
                  ...
                  <div className="text-muted-foreground text-base">Informasi suhu permukaan dari website buoys</div>
                </div>
              </div>
            </Card>
          </div>

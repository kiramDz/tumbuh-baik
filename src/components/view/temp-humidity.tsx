    ...
    <ResponsiveContainer width="100%" height="100%">
      <ChartContainer config={chartConfig}>
        ...
        >
          ...
          <XAxis dataKey="time" tickLine={false} axisLine={false} tickMargin={8} tickFormatter={timeFormatter} />
          <YAxis yAxisId="temp" orientation="left" tickLine={false} axisLine={false} tickMargin={8} tickFormatter={(value) => `${value}${temperatureUnit}`} />
          <YAxis yAxisId="humidity" orientation="right" tickLine={false} axisLine={false} tickMargin={8} tickFormatter={(value) => `${value}%`} />
          <ChartTooltip cursor={false} content={(props) => <TooltipContent {...(props as CustomTooltipProps)} temperatureUnit={temperatureUnit} />} />
          <defs>
          ...
          <Area yAxisId="temp" type="monotone" dataKey="temperature" stroke="var(--color-temperature)" fill="url(#temperatureGradient)" fillOpacity={0.4} aria-label="Temperature trend line" isAnimationActive={true} />
          <Area yAxisId="humidity" type="monotone" dataKey="humidity" stroke="var(--color-humidity)" fill="url(#humidityGradient)" fillOpacity={0.4} aria-label="Humidity trend line" isAnimationActive={true} />
        </AreaChart>
      </ChartContainer>
    </ResponsiveContainer>
  );
